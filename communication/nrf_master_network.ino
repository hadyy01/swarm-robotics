 ...
 */
 *
 * Module : NRF24L01 — Master Node (Tree Network, v1)
 * Summary: Master in a RF24Network tree topology. Broadcasts eta simultaneously
 * to up to 5 slave nodes (node01–node05) on channel 90.
 */
