 ...
 */
 *
 * Module : Reynolds Flocking — Mathematical Model (on-robot)
 * Summary: Full on-robot implementation of Reynolds' three flocking rules
 * (separation, alignment, cohesion) using 2D vector arithmetic.
 * Position and heading are estimated from TCRT5000 sensor readings;
 * inter-robot state is exchanged via nRF24L01+ wireless links.
 * The resulting flocking_vector drives the differential-drive motors.
 */
